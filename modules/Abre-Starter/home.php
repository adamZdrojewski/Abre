				...
				foreach($tasklist as $currenttask)
				{
					...
					if(strcmp($currenttaskcategory, $currentcategory) == 0)
					{
						if($currentcompleted == false)
						{
							...
							if((strcmp(unserialize($currentpriority, "red") == 0) || (strcmp(unserialize($currentpriority, "yellow") == 0) || (strcmp(unserialize($currentpriority, "green") == 0))
							{
							...
							{
								echo "<td style='width: 10%; max-width:10%; -ms-word-break: break-all; word-break: break-all;'><button class='btn white'></button></td>";
							}
