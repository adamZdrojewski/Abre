				...
				foreach($tasklist as $currenttask)
				{
					...
					if(strcmp($currenttaskcategory, $currentcategory) == 0)
					{
						if($currentcompleted == false)
						{
							...
							echo "<button class='btn {$currentpriority}' type='submit' style='width: 10%; max-width:10%; -ms-word-break: break-all; word-break: break-all;'><i class='material-icons'>edit</i></button>";
							echo "</form>";
